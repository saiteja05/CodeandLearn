...
if __name__ == '__main__':
    vectors = get_vectors()
    uri = "mongodb+srv://<uname>:<pwd>@cluster0.tcgzn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
    db_name = "ecommerce"
    coll_name = "catalog"
                ...
                for thread_count in PROCESS_COUNTS:
                    for pipeline_name, pipeline_fn in PIPELINES:
                        for num_candidates in [10, 20]:
                            ...
                            print(f"[INFO] starting benchmark of {pipeline_name} with {thread_count} threads and will hit {rpm} RPM using {SAMPLE_SIZE} random query vectors")
